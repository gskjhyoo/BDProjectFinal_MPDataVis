...
<body>
	...
	<div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1">
		<h1>M.P Geometric Visualization in Korea</h1>
		<hr>
		<table width="100%" height="100%">
			<tr>
				<td width="20%">
					...
					<!-- 지역별 어떤 병 분포  -->
					<!--  클릭이나 마우스오버시 지역의 연령대|성별 별 분포 현황 오른쪽에 보이기 -->
					...
					<font size="3">
						...
						<select style="width: 150px">
							...
							<option>실내오염</option>
							<option>수질오염</option>
							<option>기타가정 위해</option>
							<option>야외활동</option>
							<option>지역사회 위해</option>
							<option>방사선</option>
							<option>직업</option>
							<option>기후변화</option>
						</select><br/>
						...
						질병: <br/>
						<select  style="width: 150px">
							<option>감염성호흡기질환</option>
							<option>주산기질환</option>
							<option>신생물</option>
							<option>심혈관질환</option>
							<option>뇌혈관질환</option>
							<option>만성호흡기질환</option>
							<option>알레르기질환</option>
						</select><br/>
						<select  style="width: 150px">
							<option>상기도감염</option>
							<option>하기도감염</option>
							<option>중이염</option>
							<option>조산아출산</option>
							<option>폐암및기관지암</option>
							<option>허혈성질환</option>
							<option>허혈성뇌졸증</option>
							<option>COPD</option>
							<option>아토피피부염</option>
							<option>아토피비염</option>
							<option>알래르기비염</option>
							<option>천식</option>
						</select><br/>
						측정지표: <br/>
						<select  style="width: 150px">
							<option>초과사망자수</option>
							<option>YLLs</option>
							<option>YLDs</option>
							<option>DALYs</option>
						</select><br/>
						...
						<select  style="width: 150px">
							<option>전연령</option>
							<option>15세 미만</option>
							<option>15세-64세 </option>
						</select><br/>
						성별: <br/>
						<select  style="width: 150px">
							<option>남성</option>
						...
						표시 방법(단위): <br/>
						<select  style="width: 150px">
							<option>값(number)</option>
							<option>인구 10만 명당 비율(rate)</option>
						</select><br/>
						지역 수준: <br/>
						<select  style="width: 150px">
							<option>전국</option>
							<option>시도</option>
							<option>시군구보건소</option>
						</select><br/>
					</font>
				</td>
				<td width="80%">
				<!-- this area is Visualization Part --> 
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="509px" height="716.105px" viewBox="0 0 500 600" enable-background="new 0 0 509 716.105" xml:space="preserve">
<g id="서울특별시">
	<path id="강동구" fill="#B9B9B9" stroke="#FFFFFF" d="M171.5,167.272v2.167l1.167,1.25l-0.25,1.083l1.083,1.75l1.917,0.583
		l0.333-1.5l3.833-2.833l-0.333-2.5l-0.833-1.667l-3.667-0.333L171.5,167.272"/>
	<path id="송파구" fill="#B9B9B9" stroke="#FFFFFF" d="M171.5,169.439l-2.25,3.25l-3.333,0.417v2.5l2.833,2.25l1-0.083l0.667,1
		l1.167,0.917l1.25,2.5l3.75-4.583l-1.167-3v-0.5l-1.917-0.583l-0.917-1.917l0.083-0.917L171.5,169.439z"/>
	<path id="광진구" fill="#B9B9B9" stroke="#FFFFFF" d="M168.583,165.605l-1.5,0.25l-0.583,1.75l-1.25,3l-0.583,1.917l1.25,0.583
		l3.333-0.417l2.25-3.25l-0.083-1.917l-1.833-3.083L168.583,165.605z"/>
	<path id="중랑구" fill="#B9B9B9" stroke="#FFFFFF" d="M166.667,158.939l0.417,6.917l1.5-0.25l3-2.917l-0.167-3.917L171,157.855
		l-2.583,0.083L166.667,158.939z"/>
	<path id="노원구" fill="#B9B9B9" stroke="#FFFFFF" d="M164.917,146.605l-0.833,2.833l0.667,2.417l-0.5,3.75l-1.083,0.417
		l1.75,2.083l1.917,1l1.583-1.167l3,0.333l-3-5.333l-0.5-6L164.917,146.605"/>
	<path id="강남구" fill="#B9B9B9" stroke="#FFFFFF" d="M164.667,172.522L162,171.689l-2.667-0.25l-0.833,1l1.083,2.833l0.5,1.083
	...
	<path id="성동구" fill="#B9B9B9" stroke="#FFFFFF" d="M160.5,165.855l-0.25,1.583l-1.083,1.083l-0.5,0.917l0.667,2l2.667,0.25
		l2.583,1l1.75-4.083l0.167-1l-2.5-0.917l-0.917-1.083L162,165.689l-0.833,0.5L160.5,165.855z"/>
	<path id="동대문구" fill="#B9B9B9" stroke="#FFFFFF" d="M160.583,164.605l0.667-1.417l1.667-1.167l1.167-1.417l2.75-0.5
		l0.25,5.75l-0.667,2L164,166.689l-1.25-0.833l-1,0.167l-0.583,0.167l-0.667-0.333L160.583,164.605z"/>
	<path id="성북구" fill="#B9B9B9" stroke="#FFFFFF" d="M162.5,158.855l-3-0.083l-0.917-1.917l-3.417-2.167l-0.75,1.167l1,2
	...
	<path id="강북구" fill="#B9B9B9" stroke="#FFFFFF" d="M160.75,152.939l-2.25-1.333l0.583-2.917l-0.667-2.167l-2.5,2.417
		l-0.833,5l0.083,1.083l3,1.75l1.333,2l3,0.083l1.417-2.167L160.75,152.939z"/>
	<path id="도봉구" fill="#B9B9B9" stroke="#FFFFFF" d="M164.75,146.959l-1.542,0.771l-3.854-2.583l-1.083,1.5l0.625,2.021
		l-0.479,3.104l2.313,1.229l2.75,3.271l1.042-0.583l0.458-3.813l-0.75-2.271L164.75,146.959z"/>
	<path id="서초구" fill="#B9B9B9" stroke="#FFFFFF" d="M155.5,175.043l3-2.604l1.583,3.917l0.417,1.938l2,1.75l1.25,2.375
	...
	<path id="용산구" fill="#B9B9B9" stroke="#FFFFFF" d="M151.813,173.98l-1.813-2l2.938-3.5l3.125,0.063l0.625,0.438l1.979,0.458
		l0.667,2l-0.958,1.417l-2.875,2.188h-1.875L151.813,173.98z"/>
	<path id="중구" fill="#B9B9B9" stroke="#FFFFFF" d="M152.313,167.043l1.063-1.188l2-0.375l1,0.563l4.125-0.188l-0.25,1.583
		l-1.083,1.083l-0.542,1.271l-1.438-0.5l-1.125-0.75h-2.938L152.313,167.043z"/>
	<path id="종로구" fill="#B9B9B9" stroke="#FFFFFF" d="M151.688,156.98l0.25,3.688l0.5,0.813l0.188,1.813l-0.5,1.25l1.25,1.563
		l1.875-0.313l1.25,0.438l3.813-0.313l0.438-1.5l-1.313-0.125l-2.063-2.25l-2.313-0.75l1-1.313l-0.688-2.688l-2.188-1.938
		L151.688,156.98z"/>
	<path id="은평구" fill="#B9B9B9" stroke="#FFFFFF" d="M145.438,163.855l-2-1.688l1.75-1.063l0.375-6.125l2.188-0.813l2.75-2.938
	...
	<path id="서대문구" fill="#B9B9B9" stroke="#FFFFFF" d="M148.875,167.105l-3.125-3.5l1.188-1l1.313-0.063l0.625-1.063
		l1.063-0.313l0.75-1.125l1.25-0.063l0.063,1l0.688,0.563l-0.063,1.75l-0.438,1l1.188,1.813l-1.063,0.938l-0.813,0.5
		L148.875,167.105z"/>
	<path id="마포구" fill="#B9B9B9" stroke="#FFFFFF" d="M148.188,170.668l-4.938-2.25l-2.813-2.188l-2-2.125l2.188,0.125
		l2.438-2.188l0.75,0.125l1.563,1.5l0.75,0.25l2.75,2.875l2.813,0.563l0.75-0.125l1,1.438L150,171.98L148.188,170.668z"/>
	<path id="강서구" fill="#B9B9B9" stroke="#FFFFFF" d="M135.563,169.105l2,2.125l2,0.063l0.938-2.25l1.5-0.188v-1.25l-3.563-3.5
		l-1.313-0.188l-4.5-3.063l-4.792,7.333l6.229,2.604L135.563,169.105z"/>
	<path id="양천구" fill="#B9B9B9" stroke="#FFFFFF" d="M138.313,174.543l1.188,0.063l0.688,1.063l1.125-0.313l0.938-1.063
		l-0.313-2l1.063-1l-0.188-0.938l-1-1.5h-1.563l-1,2.25l-1.688,0.125l-2.188-2.188l-1.125,1.896l1.188,4.667l1.688-0.125
		L138.313,174.543z"/>
	<path id="구로구" fill="#B9B9B9" stroke="#FFFFFF" d="M143.688,178.855l-0.188-2.125l-0.625-1.75l-1-0.75l-0.813,1.125
		...
		/>
	<path id="금천구" fill="#B9B9B9" stroke="#FFFFFF" d="M146.688,183.73l-0.75-3.688l-0.75-1.063l-1.875-0.438l-2,0.813
		l3.271,7.417l2.917-1.729l-0.5-0.938L146.688,183.73z"/>
	<path id="관악구" fill="#B9B9B9" stroke="#FFFFFF" d="M148.063,177.73l3.563,0.188l1.188,2.438l2.25,0.563l0.75,1.813
		l-3.438,4.313l-2.125-0.104l-3.75-3.146l-0.75-3.75l-0.313-0.813l1.375-0.5l0.813-1h0.437V177.73z"/>
	<path id="동작구" fill="#B9B9B9" stroke="#FFFFFF" d="M148.438,173.668l-1.25,2l-0.5,1.563l-1.625,1.063l-0.188,0.688
	...
	<path id="영등포구" fill="#B9B9B9" stroke="#FFFFFF" d="M142.188,168.355l-0.188-0.75l6.188,3.063L150,171.98l1.375,1.563
...
<g id="인천광역시">
	<g id="강화군">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M96.083,132.105l-10.167-7.167l-2.167,1.833h-2.833l-4.167,4.167l0.833,7.333l-2,0.667
		...
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M89.25,169.939l-3.167,3l3.333,1.333l1.167-2.833L89.25,169.939z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M72.917,136.939l-4.167,1l-1.167,5.333l-1.667,0.333l7,5.667l0.167,4.5l4.333-0.5
			l2-4.667l-5.333-5.167L72.917,136.939z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M74.417,129.939l-4.333,5.167l-3.833-0.5l-5,2.667l-2.5-4l1.333-2.833l0.333-2.333
			l3.333-1.5l4.333,0.833l5,1.167L74.417,129.939z"/>
	</g>
	<path id="계양구" fill="#B9B9B9" stroke="#FFFFFF" d="M122.917,162.272l-1.5,2l-3.583-0.083l1.833,2l0.583,2l0.583,0.833
		l-3,2.667l0.667,1.583l8.75-0.25l0.583-4.833l3-4l-0.583-0.5l-5.833-0.583L122.917,162.272"/>
	<path id="부평구" fill="#B9B9B9" stroke="#FFFFFF" d="M117.917,175.272l1.083,2l-1,3.25l1.75,2l1.833-1.917l4.833,2l1.583-0.75
		l-2.583-2.25l-0.083-4.25l1.917-1.583v-0.75l-8.75,0.25L117.917,175.272z"/>
	<path id="서구" fill="#B9B9B9" stroke="#FFFFFF" d="M118.083,180.272l-2.667-0.333l-3-2.25v-1.5l-3-0.417l0.083-2.75l4.25-0.667
	...
	<path id="연수구" fill="#B9B9B9" stroke="#FFFFFF" d="M120.5,188.105l-3.583-0.917l-6.333,0.75l1.417,2.25l3.333,2.75
		L120.5,188.105z"/>
	<path id="남구" fill="#B9B9B9" stroke="#FFFFFF" d="M112.583,187.522L112,184.939l1.167-3.25l2.25-1.75l2.25,0.25l1.833,2.083
		l0.417,3.583l0.583,2.25l-3.333-1L112.583,187.522z"/>
	<path id="남동구" fill="#B9B9B9" stroke="#FFFFFF" d="M115.333,192.939l5.167-4.833l-0.583-2.25l-0.167-3.333l1.833-1.917
		l4.833,2l1.583-0.75l1.75,1.25l-6.25,11.917l-5.417-0.167L115.333,192.939z"/>
	<path id="동구" fill="#B9B9B9" stroke="#FFFFFF" d="M113.125,182.23l-2.375-1.375l-2.875-2.188l2-1.313l1.438-1.438l1.104,0.271
		l0.271,1.479l2.5,2.25l-1.75,1.563L113.125,182.23z"/>
	<g id="중구_1_">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M95.917,170.939l-1.5,1.5l-1.167,3.833l-6.833,0.333l0.667,2.667l-2.833,2l4.5,6
			l4.667-2.5l2.5-3.5l3.667-1l4.833-1.833l-2.667-4.333L95.917,170.939z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M87.083,190.772l2.5,2.667l1.333-2.333l-2.167-0.833L87.083,190.772z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M110.583,187.939l-1.833-1.146l-0.188-2.063l-1.438,1.188l-1.063-0.938l0.063-2.125
			l1.375-1.938l0.188-2.25l1.188,0.625l2.188,2.063l2.063,0.875l-1.063,3.063l0.75,2.375L110.583,187.939z"/>
	</g>
	<g id="옹진군">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M90.083,210.772l-3.5,2.167l0.167,5.833l2.5,1l2.833-2.333l1.167-1.5l2.667-0.5
			l-1.5-2.833L90.083,210.772z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M45.25,212.606l-1.167,3.5l-0.833,4.667l3,0.667l2,1.5l2.333-0.667l2.167-2.5
			l-3.333-3.167l-2.5-1.333l-0.333-2.333L45.25,212.606z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M73.583,214.439l-5.333-2l0.167,2.333l5.167,3.333l2.667-2.333L73.583,214.439z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M20.5,171.355l4-1.75l-2.25-2.5l-4.5-0.25l-3,1.25l-3.75-0.25l-0.75,1l2,2.75l1.25,2.5
			l3.5,0.25l3.25,1l-0.25-2.5L20.5,171.355z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M21.25,186.105l-1.75-1l-2.5,2.25l-1.75,1l2.25,2.5l3-0.5l0.75-2.25V186.105z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M44.25,188.855l-3.25-0.25l-0.25,1.75l3,1.5v-1.5L44.25,188.855z"/>
	</g>
</g>
<g id="경기도">
	<path id="김포시" fill="#B9B9B9" stroke="#FFFFFF" d="M131.417,159.105l-16.167-11l2.833-5.5l-1.833-3.833l-0.667-6.333
	...
	<path id="고양시" fill="#B9B9B9" stroke="#FFFFFF" d="M117.083,145.772l2.5,0.333l4.167-1l6.167-0.5l2.333-4.333l2.333,0.833
	...
	<path id="파주시" fill="#B9B9B9" stroke="#FFFFFF" d="M116.583,124.439l3.167-1.667l7.333-0.667l-6-9.833l-5.5-0.333l0.167-6.5
	...
	<path id="양주시" fill="#B9B9B9" stroke="#FFFFFF" d="M158.083,109.272l-4.333-1.333l-3.167,3.5l-1,9.667l-0.833,2.667
		...
		L158.083,109.272z"/>
	<path id="의정부시" fill="#B9B9B9" stroke="#FFFFFF" d="M174.583,136.939l-2,2.833l-0.5,2l-4.167,5.167l-3-0.333l-1.667,1.333
		l-3.833-2.833l-1.5-4.833l-1.833-3.333l3-2.333l3.833,0.833l7.667-3.167l2.667,2.167L174.583,136.939z"/>
	<path id="동두천시" fill="#B9B9B9" stroke="#FFFFFF" d="M163.917,101.939l-6.167,7.833l-0.5,3.333l3.667,2.333l1.5,3.167
		l7.833,1.667l2.333-2.167h2.167l0.667-3.167l-1.833-3.333l-5.167-5v-3.833L163.917,101.939z"/>
	<path id="연천군" fill="#B9B9B9" stroke="#FFFFFF" d="M144.25,86.439l-1.667,5.833l-0.667,3.667l-5.333-2.667l-1.167,5
	...
	<path id="포천시" fill="#B9B9B9" stroke="#FFFFFF" d="M174.583,136.939l4.5-0.167l3.667-1l2.5,0.667l5.167-3.333l2.667-14.167
	...
	<path id="구리시" fill="#B9B9B9" stroke="#FFFFFF" d="M178.417,165.605l1.5-3.5l-4-1.667l-1.167-6.667l-2.167,1.167l-3-0.333
		l1.833,4.167l0.167,3.667l-2,2l1.667,2.833l3.5-2L178.417,165.605z"/>
	<path id="남양주시" fill="#B9B9B9" stroke="#FFFFFF" d="M193.75,133.939l5,3.667l2.167,4.833l1,4.167l2.167,2.5l-0.667,4.5
	...
	<path id="하남시" fill="#B9B9B9" stroke="#FFFFFF" d="M174.417,180.439l3.167,0.667l2.5-1.5l6,0.333l1.5,1l1.667-2.333
		...
		L174.417,180.439z"/>
	<path id="양평군" fill="#B9B9B9" stroke="#FFFFFF" d="M210.917,150.605l-3.833,2.333l-3.667,0.667l-3.833,4.667l-0.333,6.833
		...
		L210.917,150.605z"/>
	<path id="가평군" fill="#B9B9B9" stroke="#FFFFFF" d="M213.917,95.939l-0.833-4.5l-2.5,0.833l-1.667,4.167l-4.667,6.333
	...
	<path id="여주군" fill="#B9B9B9" stroke="#FFFFFF" d="M212.25,199.605v-5.167l-5.167-4.667l3.167-3.667l5.833,2.833l4.5-2.5
	...
	<path id="광주시" fill="#B9B9B9" stroke="#FFFFFF" d="M198.917,212.272l4.833-7l2.5-0.333l6-5.333v-5.167l-5.167-4.667l-4-5.667
	...
	<path id="성남시" fill="#B9B9B9" stroke="#FFFFFF" d="M162.583,188.439l-2,8l6.167,3.167l4.333,3.5h2.333v-2.333l4.5-4
		l0.667-3.5l3.667-6.333l-3.5-6.5l-1.167,0.667l-3.167-0.667l-1.667,2l-3,0.167l-4.167,5.833l-2.5-1L162.583,188.439z"/>
	<path id="과천시" fill="#B9B9B9" stroke="#FFFFFF" d="M154.917,191.605l7.167-2.5l1-1.667l-1.667-4l-6.167-0.5l-2.833,3.833
		v2.333L154.917,191.605z"/>
	<path id="의왕시" fill="#B9B9B9" stroke="#FFFFFF" d="M153.583,194.272l-1.333,5.333l-2.5,5.667l-1,2.167l3.5,0.5l1-3.167
		l3.167-1.833l2.833-2.833l1.333-3.667l1.5-7.333l-6.667,2.5l-1.333,0.833L153.583,194.272z"/>
	<path id="용인시" fill="#B9B9B9" stroke="#FFFFFF" d="M161.417,201.939l-2.167-1.833l1.333-3.667l6.167,3.167l4.333,3.5
	...
	<path id="안양시" fill="#B9B9B9" stroke="#FFFFFF" d="M149.25,195.939h-2.5l-2.333,2.667l-3-4.667l1-3.667l2.167-3.5l3.167-2
		l2.5,2.167l2.167-0.167v2.333l2.5,2.5l-0.833,0.833l-1.667,5.667L149.25,195.939z"/>
	<path id="부천시" fill="#B9B9B9" stroke="#FFFFFF" d="M134.917,181.105l-0.5,1.833l-5.167,0.167l-3.833-3.833l-0.333-4
		l2.167-1.5l0.667-5.333l6.333,2.5l1.5,4.833l-2,1.667L134.917,181.105z"/>
	<path id="광명시" fill="#B9B9B9" stroke="#FFFFFF" d="M136.583,183.605l-2.167-0.667l0.5-1.833l3-1.167l2.5-1.667l1.333,1.833
		l2.833,6.667l-2.167,3.5l-0.667,1.667l-3.667-0.5l-0.833-6.833L136.583,183.605z"/>
	<path id="시흥시" fill="#B9B9B9" stroke="#FFFFFF" d="M121.583,197.439l-4,4.5l4.667,3.5l4.333-3.5l5-0.5l3.5-2.833l5.667-1.333
		l1-2.167l-0.333-1.167l0.333-2l-3.667-0.5l-1-6.333l-0.5-1.5l-2.167-0.667l-5.167,0.833l-5.667,10.833L121.583,197.439z"/>
	<path id="이천시" fill="#B9B9B9" stroke="#FFFFFF" d="M221.25,245.605l1-5.167l-2.833-4.833l-4-0.833l-1.667-2.5l-2.167,0.167
	...
	<path id="수원시" fill="#B9B9B9" stroke="#FFFFFF" d="M149.375,209.355l-1.5,2.625l0.5,2.5c0,0,2.5,0.375,2.5,0.75
	...
	<path id="군포시" fill="#B9B9B9" stroke="#FFFFFF" d="M148.75,207.439L145,205.73l-3.375-1.25l1.5-5.875l1.25-0.375l2.125-2
		l2.75-0.292l3.167,2.167l-0.167,1.5L148.75,207.439z"/>
	<path id="안산시" fill="#B9B9B9" stroke="#FFFFFF" d="M122.25,205.439l5.625,3.042l5.875,0.375l1.5-0.125l2.75,3.875l5.625-2
		...
		L122.25,205.439z"/>
	<path id="오산시" fill="#B9B9B9" stroke="#FFFFFF" d="M163,234.98l5.5-0.5l1.375-1.75l-0.5-2.125l-2.5-0.375l-1.5-3.625
		l-1.25-2.375h-4.875l-2.375,4.125l3.625,2.375l0.25,3L163,234.98z"/>
	<path id="평택시" fill="#B9B9B9" stroke="#FFFFFF" d="M146.625,269.48l10.125-5.125l4.875,1.625l6.5-2.875l3.25-4.25h2.75
	...
	<path id="안성시" fill="#B9B9B9" stroke="#FFFFFF" d="M193.375,270.48l-4.75-4.125l-4.25-0.375l-3.25-4.25l-7-2.875L175,255.23
	...
	<g id="화성시">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M135.375,211.98l-4.125,0.125l-1.125,3.125l-0.875,2.5l-3-2.75l-1.625,0.375L121,214.98
		...
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M109.625,216.73L108,214.355l-3.125-0.5l-1.625-2.75l-4.5-0.625l2.25,4l1,3l-2.5,1.375
			l0.125,5.375l3,0.125l2.625-4l3.75,2.75l-0.125-3.875l1.25-1.125L109.625,216.73z"/>
	</g>
</g>
<g id="강원도">
	<path id="철원군" fill="#B9B9B9" stroke="#FFFFFF" d="M231.417,45.272h-3.833l-7,5.167l-3.833-0.333l-1.667-2.167h-3
	...
	<path id="화천군" fill="#B9B9B9" stroke="#FFFFFF" d="M227.417,85.772l-0.333,3.667l2,2.667l-2.333,2.833l-3.333,2l-0.167,1.167
	...
	<path id="춘천시" fill="#B9B9B9" stroke="#FFFFFF" d="M233.417,148.939l2-3.667l1.833,2.833l2.333-2.5h2.5l-0.5-3l6.167-2.833
	...
	<path id="홍천군" fill="#B9B9B9" stroke="#FFFFFF" d="M353.417,120.105l-4.834-5.833l-4.666,0.667l-3.167-0.5l-5.5,3.5
	...
	<path id="횡성군" fill="#B9B9B9" stroke="#FFFFFF" d="M288,202.855l-0.25-5.75l4-1l-0.5-4l2.75-2l-5-5.5l-6-1.5l-4-1.5l-1.5,2
	...
	<path id="원주시" fill="#B9B9B9" stroke="#FFFFFF" d="M307,216.105l-4.25,4.25l-4.75-3l-3.25,5.25l-8.75,1.75v-2.75l-2.5-5.5
	...
	<path id="양구군" fill="#B9B9B9" stroke="#FFFFFF" d="M294.75,44.605l-7,4l-6.25-1.5l-5-1l-3.25-1.5l-8-1l-3.25,2.25
		...
		/>
	<path id="인제군" fill="#B9B9B9" stroke="#FFFFFF" d="M306.75,37.105l-12,7.5l5,1.5l-0.25,9.5l-4,5.25l-0.5,3.5l-4.75,9.75l3,5
	...
	<path id="고성군" fill="#B9B9B9" stroke="#FFFFFF" d="M340.083,66.939l13.334-7l-8.334-17.5l-1.333-4.333l-7.167-10l1.334-1.833
	...
	<path id="속초시" fill="#B9B9B9" stroke="#FFFFFF" d="M356.417,70.939l-0.167-3.667l-1.833-2.667l1-1l-2-3.667l-13.334,7
		l-5.666-1.167l-2.5,2.5l6.666,7.833l3.667-1.5l4.667-0.333l4.5-2.5L356.417,70.939z"/>
	<path id="양양군" opacity="0.98" fill="#B9B9B9" stroke="#FFFFFF" enable-background="new    " d="M353.417,120.105l7.333-7.333
	...
	<path id="평창군" opacity="0.98" fill="#B9B9B9" stroke="#FFFFFF" enable-background="new    " d="M355.083,210.772l1.167-1.833
	...
	<path id="강릉시" fill="#B9B9B9" stroke="#FFFFFF" d="M380.25,168.105h-8.167l-2.666,1.667l-4.667-4l2.5-4.833l3.333-0.5
	...
	<path id="정선군" fill="#B9B9B9" stroke="#FFFFFF" d="M401.25,182.105l4-6l-3.5-4l1-3.333l-1.333-2l-2.667,2.667l-4.5-4.333
	...
	<path id="동해시" fill="#B9B9B9" stroke="#FFFFFF" d="M407.917,185.605l6.166-5.167l9.667-0.167l3.333-2.333l-2.666-4.667
		l-4.5-6.167l2.166-2.5l-1.5-3.333l-6.666-5l-2.334,10l-8.833,2.5l-1,3.333l3.5,3.333l-4,6.667l2.667,3L407.917,185.605z"/>
	<path id="영월군" fill="#B9B9B9" stroke="#FFFFFF" d="M390.917,235.105l2.833,2.333l-2.333,3.667l0.333,2.833l-4-1.167l-6.833-4
	...
	<path id="태백시" fill="#B9B9B9" stroke="#FFFFFF" d="M397.417,213.939l1.166-1.167l0.167-3.833l4.167-8.833l5.166-1.5l-1,2.5
	...
	<path id="삼척시" fill="#B9B9B9" stroke="#FFFFFF" d="M431.917,244.272l5.333-0.333l-0.333-5.333l5.833-5.667l3.667-0.333
...
<g id="충청북도">
	<path id="진천군" fill="#B9B9B9" stroke="#FFFFFF" d="M196.75,276.272l2.833,0.833l0.167,4.667l5.167,2.333l3.333,2.667
	...
	<path id="음성군" fill="#B9B9B9" stroke="#FFFFFF" d="M244.25,273.605l-1.75,4.25l-4.375-1.5l-3.75,3.875l-1.125-2.5l-4.875-2
		...
		L244.25,273.605z"/>
	<path id="충주시" fill="#B9B9B9" stroke="#FFFFFF" d="M258.375,262.855l3.625,1.25l1.375,3.75l5.5,3.625l5,1l1.25-0.625l2,1.875
	...
	<path id="제천시" fill="#B9B9B9" stroke="#FFFFFF" d="M310.5,244.355l5.375-4.25l-1.5-3.125l2.25-1.875l3.125,2.375l1.25-2
	...
	<path id="단양군" fill="#B9B9B9" stroke="#FFFFFF" d="M316.5,273.855l6.5,7.625l3.75,1.375l2.25,2.125l3.5-3.375l3.875,0.25
	...
	<path id="괴산군" fill="#B9B9B9" stroke="#FFFFFF" d="M257.75,316.355l-3.25-0.625l-7.875-8.375l2.125-3.75l-6.625-5.75
	...
	<path id="증평군" fill="#B9B9B9" stroke="#FFFFFF" d="M240.125,299.605l2-1.75l-4.125-2.25l-2.25-7.25l1.625-2.75l-1.25-3.125
		...
		L240.125,299.605z"/>
	<path id="청원군" fill="#B9B9B9" stroke="#FFFFFF" d="M209.625,293.355l-2.625,1l-2.5-1.5l-3.25-0.25l-2.5,1.25l0.25,2.625
	...
	<path id="청주시" fill="#B9B9B9" stroke="#FFFFFF" d="M217.375,298.855l-2.75,3.375l-2.625,2.5l-3.375,0.375l-1.5,0.625
		l-0.375,3h-2.125l1.75,3.625l-2.125,1.625l-0.75,3.5l1.375,2.375l4.5-2.75l3.875,0.625l1.875-1.125l1.625,0.875l2,2.125l4.5-2.625
		l3.25-0.75l0.375-3.75l-0.75-3.125l-1-2.875l-2.375,1.125l-2.5-2.875l-0.375-5.25L217.375,298.855z"/>
	<path id="보은군" fill="#B9B9B9" stroke="#FFFFFF" d="M225.917,345.938l-3.292-0.833l0.792-2.5l3.083-1.625l3.25-7.708
	...
	<path id="옥천군" fill="#B9B9B9" stroke="#FFFFFF" d="M233.25,382.438l6.333,1.334l1.5-8.167l3.333-1.667l4.5-4.5l4.833-0.166
	...
	<path id="영동군" fill="#B9B9B9" stroke="#FFFFFF" d="M244.25,400.605l-3.167,2.667l-3.167-4.167l-2.5-5.833l-3.5-3.334l1.5-3.5
...
<g id="대전광역시">
	<path id="유성구" fill="#B9B9B9" stroke="#FFFFFF" d="M209.875,345.855l-2.375-5.5l0.375-1.125l-0.125-4.75l-2.375-1.875
	...
	<path id="서구_3_" fill="#B9B9B9" stroke="#FFFFFF" d="M208.375,357.23l-1.5-4.375l-3.75,0.5l-2,7.25l-7.375,9.375l-0.875,3.25
		l3.5,3.875l3.625,4l3-4.5l-0.125-5.375l1.75-2.875l-0.25-2.5l2.125-2.875l1.125-4.25L208.375,357.23z"/>
	<path id="중구_5_" fill="#B9B9B9" stroke="#FFFFFF" d="M206,368.73l0.375,5.875l3.875,3.875l1.5-2.625l1.5-2.875l-1.25-2.25
		...
		"/>
	<path id="대덕구" fill="#B9B9B9" stroke="#FFFFFF" d="M216,355.105l-1.5-4.5l4.75-7l0.875-3.125l-1.25-1.125l-1-3.5l-1.5,1.75
		...
		L216,355.105z"/>
	<path id="동구_4_" fill="#B9B9B9" stroke="#FFFFFF" d="M213.25,380.73l-3-2.25l3-5.5l-1.25-2.25l0.5-2.5l-0.875-2.375
...
<g id="충청남도">
	<path id="천안시" fill="#B9B9B9" stroke="#FFFFFF" d="M159,307.48l4.875-6.5l2.875-0.875c0,0,1.125-4.375,1.125-4.75
	...
	<path id="계룡시" fill="#B9B9B9" stroke="#FFFFFF" d="M190.875,374.73l-3.625-0.125l-1.125-2.75l-2.875,0.125l-1.75-4.875
		l1.5-2.5l0.125-2.75l-1.5-2.75L184,355.98l3.375,0.875l2.375,3.75l-0.625,4.625l-1.625,1.625l6.25,3.125l-0.875,3.25
		L190.875,374.73z"/>
	<path id="공주시" fill="#B9B9B9" stroke="#FFFFFF" d="M170.75,358.105l-2.25,0.25l-3.5,8.75l-9.5-3.625v-11.625l4.375-3.625
	...
	<path id="아산시" fill="#B9B9B9" stroke="#FFFFFF" d="M139,286.23l-0.375-3l-1.625-7.5l4-4.5l5-0.25l-0.125-1.5l1.125-0.375
	...
	<path id="당진시" fill="#B9B9B9" stroke="#FFFFFF" d="M91.625,268.855l1.125-7.75l-0.875-6l-4-5.5l4.625-3.75l0.25-1.625
	...
	<path id="예산군" fill="#B9B9B9" stroke="#FFFFFF" d="M138.375,322.105l-5.125,7l-4.75-1l-2.875,0.125L125,323.98l2-4.75
	...
	<g id="서산시">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M74,298.23l2.75-11.125l-4-4.75l-0.875-3.25l2.5-3.375l2.5,4.5l0.875-7.25l4.125-2.5
			...
			L74,298.23z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M69.375,257.48l-2,1.75v4.25L70,265.605l0.5-4L69.375,257.48z"/>
	</g>
	<g id="태안시">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M70.5,268.73l-3-2.25l-3.625,6l-4.375,2.375l1-3.5l3-3.625l-4.25,0.5l-4.5,1.875
		...
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M76.125,314.48l-3.375,2.125l-2.625,4.125l2.375,4.875l0.25,7.75l-0.5,4.5l3,5.125
			l1.25,2.375l4.375,1.75l1.75,1.625L86,344.98l-1.625-7.25l-3.25-7.875l-1-3.5l1.25-5.375l-0.625-3.625L76.125,314.48z"/>
	</g>
	<path id="홍성군" fill="#B9B9B9" stroke="#FFFFFF" d="M91.375,330.605l-3.75-5.875l0.5-6.625l2.75-1.125l-1.375-2.75v-7.125
		...
		L91.375,330.605z"/>
	<path id="청양군" fill="#B9B9B9" stroke="#FFFFFF" d="M120.125,348.855l-2-4.375l-3.5-5.875l4.5-1.75h5.375l3-5.625l1-3.125
	...
	<path id="논산시" fill="#B9B9B9" stroke="#FFFFFF" d="M163.375,388.355l2,5.625l0.875,3.375l6.125,3l2.875-3.25h7l2.625-2.125
	...
	<path id="금산군" fill="#B9B9B9" stroke="#FFFFFF" d="M209.417,409.105l2.167-2.333l3.833,5.833l9.333-0.333l1-8.167l10,6.333
	...
	<path id="부여군" fill="#B9B9B9" stroke="#FFFFFF" d="M120.75,353.355l-4.125,8.375l2.25,5.875l2.125,3.75l3.375,1.375
	...
	<g id="보령시">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M85.25,351.355c-0.5,0-5.625,0.875-5.625,0.875l0.25,1.625l5.375,0.75l2.875,1.25
			l0.5-1.125l-2.5-2.25L85.25,351.355z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M102.625,381.605l2.625,2.625l8.125-0.75l4-2l3.625-4.75l2.75-1.375l0.625-2.625
	...
	<path id="서천군" fill="#B9B9B9" stroke="#FFFFFF" d="M119.875,410.605l3.875-0.625l3.625-4l6.625-0.25l5.375-4.25l1.875-2.875
...
<g id="제주특별자치도">
	<g id="제주시_1_">
		<path id="제주시" fill="#B9B9B9" stroke="#FFFFFF" d="M381.083,674.105l12.667-11.666l0.333-3.166l4.334-2.834l2.5-3
		...
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M484.583,646.439l-1.5,3.166l2,2.334l1.5-1.166l0.834-3.334L484.583,646.439z"/>
	</g>
	<g id="서귀포시">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M383.25,686.439l-2.167-4l4-1.334l6.167,3.834l2.167-2.666l9.166-6.834l6.334-1l8.833,1
		...
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M394.417,706.773l-0.5,3.5l1.5,0.332l1.333-2.332L394.417,706.773z"/>
	</g>
</g>
<g id="경상북도">
	<path id="문경시" fill="#B9B9B9" stroke="#FFFFFF" d="M298.083,313.939l4,2.5l7.834,3.667l1.166,7.167l5.5,0.333l0.667-2.833
		...
		L298.083,313.939z"/>
	<path id="상주시" fill="#B9B9B9" stroke="#FFFFFF" d="M298.75,372.772l2.167-3.667l2.333-5.333l7.834-0.5l2.5-6.834l3.666-2.833
	...
	<path id="예천군" fill="#B9B9B9" stroke="#FFFFFF" d="M339.417,327.939l2.666-5.5l3.667-2.667v-5.167l4.5-0.667l-0.167-3.167
	...
	<path id="영주시" fill="#B9B9B9" stroke="#FFFFFF" d="M375.583,299.105l-0.333-13.5l-1-3l1.667-5.167l-2.5-3.167l-6.167,0.667
		...
		L375.583,299.105z"/>
	<path id="봉화군" fill="#B9B9B9" stroke="#FFFFFF" d="M408.417,291.439l-2.667,0.5l-3.833-4l-5.167-0.333l-9.167-5.5l-2.5,1.167
	...
	<path id="영양군" fill="#B9B9B9" stroke="#FFFFFF" d="M443.75,302.605l2.333-6.667l-3.166-4.5l5.5-6.833l-5-6.833l0.166-5.333
	...
	<path id="울진군" fill="#B9B9B9" stroke="#FFFFFF" d="M463.417,303.772l-8.5,0.167l-2.334,2l-4-2.5l-4.833-0.833l2.333-6.667
		...
		L463.417,303.772z"/>
	<path id="안동시" fill="#B9B9B9" stroke="#FFFFFF" d="M397.083,362.438l-2.833-9.833l-4.833-7.667l-1.667-5.333l-10-5.833
	...
	<path id="의성군" fill="#B9B9B9" stroke="#FFFFFF" d="M340.583,359.605l-5,6l-7.333-9.667l-4.834,3l-2.999-3l2.833-5.333
	...
	<path id="김천시" fill="#B9B9B9" stroke="#FFFFFF" d="M292.916,435.105l2.334-4.832l-4.334-10.335l2.5-0.333l2.334,2.334
	...
	<path id="구미시" fill="#B9B9B9" stroke="#FFFFFF" d="M331.916,400.105l4.167-5c0,0,7.001,2.833,7.167,2.333
	...
	<path id="성주군" fill="#B9B9B9" stroke="#FFFFFF" d="M304.917,444.939l1.333-1.834l-0.5-3.332l5.333-1l3.667,4.664l5.167-5.664
		...
		L304.917,444.939z"/>
	<path id="고령군" fill="#B9B9B9" stroke="#FFFFFF" d="M304.583,463.273l0.334-2l6-4.334l-2.334-6.834l-3.666-5.166l1.333-1.834
	...
	<path id="칠곡군" fill="#B9B9B9" stroke="#FFFFFF" d="M348.417,425.939l-4.334-1.334l-0.333-5.167l-2.5-1.166l-5.167,4.501
		...
		/>
	<path id="군위군" fill="#B9B9B9" stroke="#FFFFFF" d="M372.917,406.771l0.666-8.5l4.667-6l5.5,1.834l3.5,0.833l4.333-7
	...
	<path id="영덕군" fill="#B9B9B9" stroke="#FFFFFF" d="M458,365.355l-10.25-0.5l1-5.75l-2.25-2.5l-3.5,0.5l-4.25-4.5l-0.25-5
		...
		/>
	<path id="청송군" fill="#B9B9B9" stroke="#FFFFFF" d="M419.25,374.605l2-3.25l-4.75-3.75l2.75-1.75l8.25,2.25l5.5,6l6-9.5v-4.25
		...
		L419.25,374.605z"/>
	<path id="포항시" fill="#B9B9B9" stroke="#FFFFFF" d="M446.5,395.605l-4.25,0.5l-1.25,3.75l-5.5,1.5l-4-3l-3-0.75l-0.5-2.25
	...
	<path id="영천시" fill="#B9B9B9" stroke="#FFFFFF" d="M406,434.105l-7-1l-4.25-5l0.5-3l-1.75-3.75l-0.5-6l-6.5-2l-3.5-2.75
	...
	<path id="경산시" fill="#B9B9B9" stroke="#FFFFFF" d="M402.75,445.355l-4,0.75l-5.25,2l-8,0.5l-3.75,7.25l-5.5-3l-3.75-4.25
	...
	<path id="청도군" fill="#B9B9B9" stroke="#FFFFFF" d="M369,472.855l-5.5,2.5l-9.25-7.5l-2-5.25l-0.75-3.75l0.75-4.25l4.5-3.5
	...
	<path id="경주시" fill="#B9B9B9" stroke="#FFFFFF" d="M458,457.355l-7.25,4.75l-4.5-1.25l-0.5-7l-6.5-1.75l-6.75,0.25l-1.25-1
		...
		L458,457.355z"/>
	<g id="울릉군">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M493.25,352.105l-3.25-0.25l-2.25,1.5l-3.75,2.5l-4.25,0.25l-2.75,0.5l1.25,2.5l1,2.5v2
			l8,3l0.75-2l4-2.75l0.25-6L493.25,352.105z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M504.25,365.105l-1.25,2.5l2,1l1.25-2.5L504.25,365.105z"/>
	</g>
</g>
<g id="대구광역시">
	<path id="동구_3_" fill="#B9B9B9" stroke="#FFFFFF" d="M367.25,428.605l-3.333,1.834l-1.334-1.834l1.667-3.166l0.667-2.834
	...
	<path id="북구_2_" fill="#B9B9B9" stroke="#FFFFFF" d="M360.917,428.773l-2.667,0.332l-0.333-2.5l-3.167-0.5l-3.667,1.168
		l-2.666-1.334l2.333-4.166l0.833-4.168l-1-3.667l1.334-1.333l2.5,1.667l6-3l3.333,7l1.167,4.333l-0.667,2.834l-1.5,2.666
		L360.917,428.773z"/>
	<path id="수성구" fill="#B9B9B9" stroke="#FFFFFF" d="M361.75,432.273l-0.333,5l-1.667,1.5l4.5,0.5l3.333,1.5l5.167,1.832
		l3.25-2.5l-0.417-4.666l2.5-4.166l-6.666-0.668l-0.5-1.832l-3.667-0.168l-3.333,1.834L361.75,432.273z"/>
	<path id="중구_4_" fill="#B9B9B9" stroke="#FFFFFF" d="M357.75,431.939l0.5-2.834l4-1l1.667,2.334l-2.167,1.834L357.75,431.939z"
		/>
	<path id="서구_2_" fill="#B9B9B9" stroke="#FFFFFF" d="M350.25,430.105l0.833-2.832l3.667-1.168l3.167,0.5l0.333,2.5l-0.5,1.834
		l-2.667,1h-1.833L350.25,430.105z"/>
	<path id="남구_3_" fill="#B9B9B9" stroke="#FFFFFF" d="M356.083,433.773l-0.666,2.666l4.333,2.334l1.667-1.5l0.333-5l-4-0.334v-1
		l-1.5,0.834L356.083,433.773z"/>
	<path id="달서구" fill="#B9B9B9" stroke="#FFFFFF" d="M347.417,439.105l2.166,1.334l2.667,2.666l4.5,1.5l1.833-2.832l1.167-3
		l-4.333-2.334l0.666-3.166l0.167-1.5l-1.167,0.166h-1.833l-3-1.834l-4.833,0.668l-0.167,5.664l-0.5,2L347.417,439.105z"/>
	<g id="달성군">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M345.417,430.773l4.833-0.668l0.833-2.832l-7-2.668l-0.333-5.167l-2.5-1.166
			l-4.667,4.001l-2.833,4.832v7.168l4.833-1.168l6.667,3.334L345.417,430.773z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M342.583,466.773l7-0.168l1-5.5l0.917-2.25l0.75-4.25l4.5-3.5l7.25,0.25l-0.5,4.5
...
<g id="울산광역시">
	<path id="북구_1_" fill="#B9B9B9" stroke="#FFFFFF" d="M456.75,471.355h-3.375L451,472.73l-0.5-7.125l0.25-3.5l7.25-4.75
		l10.25,4.25l1.25,4.5l2.125,3l-0.25,3.375l-1.5,2l-3,0.75l-2.625,2.5v4.75l-6.375-4.75l-0.625-4.5L456.75,471.355z"/>
	<path id="중구_3_" fill="#B9B9B9" stroke="#FFFFFF" d="M455.875,477.98l-4.5,0.125l-1,0.875l-2.125-1.375l-2.125-0.25
		l-0.375-3.375l3.25-1.5l2,0.25l2.375-1.375h3.375l0.5,2.25l0.625,4.125L455.875,477.98z"/>
	<path id="동구_2_" fill="#B9B9B9" stroke="#FFFFFF" d="M463.25,484.98l1-2.5v-4.75l2.625-2.5l3-0.75l1.375,1.75l-1.125,2.875
		L470,484.73l-1.625,3l-3,2.375l-0.375-4.25L463.25,484.98z"/>
	<path id="남구_2_" fill="#B9B9B9" stroke="#FFFFFF" d="M462,489.605l-3.875,2.375l-2.375-3.625l-3.5-2l-4.75-5.125l-3.5-1
		l2.125-2.875l2.125,0.25l2.125,1.375l1-0.875l6.5-0.375l5,3.625l-0.875,2.5l-0.25,2.375L462,489.605z"/>
	<path id="울주군" fill="#B9B9B9" stroke="#FFFFFF" d="M459.5,507.605l-0.875-4.25l0.875-2.625l-0.625-2.75l1.25-2.25l-2-3.75
...
<g id="경상남도">
	<path id="거창군" fill="#B9B9B9" stroke="#FFFFFF" d="M243,446.855l4.75,3.5l0.5,3l5-1.5l3.5,4l4.75,4l3.75,4l3-0.75l0.25,7.75
		...
		L243,446.855z"/>
	<path id="합천군" fill="#B9B9B9" stroke="#FFFFFF" d="M297.25,508.855l-5.25-7h-3.75l-6-9.5l-3.5-6.25l5.25-11.5l1.75-8l5.75-6
	...
	<path id="함양군" fill="#B9B9B9" stroke="#FFFFFF" d="M247.25,516.105l4.75-4l6.5-15.25l2.25-4.75l0.5-4.25l1.25-4l3.75-5.5
	...
	<path id="창녕군" fill="#B9B9B9" stroke="#FFFFFF" d="M335,494.105l3.75-4l-4.75-3.75l-2.25-0.25l-2.75-4.5l1.5-4l-0.25-4.5
	...
	<path id="밀양시" fill="#B9B9B9" stroke="#FFFFFF" d="M387.25,510.605l8-6.25l4.5-5l4,0.25l-1.25-4.25l6.25-2.25l-0.25-6.75
		...
		L387.25,510.605z"/>
	<path id="양산시" fill="#B9B9B9" stroke="#FFFFFF" d="M430.5,507.605l-1.5,9.5l-12,5l-6.75-5.25l-0.75-4.25l-5.5-4.25l-5.75-0.5
	...
	<path id="김해시" fill="#B9B9B9" stroke="#FFFFFF" d="M388.5,541.605l-7.75-2.75l-0.25-5.25l-2-0.5l-1-5.75l-4-9.25l5-3.25
	...
	<path id="창원시" fill="#B9B9B9" stroke="#FFFFFF" d="M358.875,509.605l-1.625,2.375l0.25,3.375l1.875,1.75v2.75l1.375,4.125
	...
	<path id="함안군" fill="#B9B9B9" stroke="#FFFFFF" d="M322.25,527.773l-2.167-1.5l3.667-3.668l-0.5-3.5l1.5-4.166l1.667-5
	...
	<path id="의령군" fill="#B9B9B9" stroke="#FFFFFF" d="M310.417,525.273l-2.834-4l0.5-5.5l-4-3l-3.333,3l-3.5-2.168v-4.75
		...
		/>
	<path id="산청군" fill="#B9B9B9" stroke="#FFFFFF" d="M269.25,526.773l-4.167,5.166h-8.166l-4.334-4.334l-5.667-3.5l0.333-8
	...
	<path id="진주시" fill="#B9B9B9" stroke="#FFFFFF" d="M307.417,551.939l-2.834-3.166l-6.333,2.332l-2.167-2.666l-3.333-1.5
	...
	<path id="고성군_1_" fill="#B9B9B9" stroke="#FFFFFF" d="M299.917,578.939l4.833-10.334l2.667-0.5l-1.167-5.166l3.667-2.334
	...
	<g id="거제시">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M354.083,578.939l4.667,2.666l3.5-2l3.167,2.5l-3.167-5.666l2.5-4.666l3,0.166l3-3.166
		...
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M354.083,570.773l-1.833,1.332l0.167,4c0,0,3.333,1.168,3.333,0.168s0-3,0-3
			l-1.167-0.168l-0.5-2.666"/>
	</g>
	<path id="사천시" fill="#B9B9B9" stroke="#FFFFFF" d="M276.583,544.273l-4-0.5c0,0-2.166,1.834-1.666,2s3.666,3.666,3.666,3.666
		...
		L276.583,544.273z"/>
	<path id="하동군" fill="#B9B9B9" stroke="#FFFFFF" d="M236.083,516.105l-5,4.5l1.833,3.168l4.833,6.332l-0.667,8.168l8.5,7.666
		...
		L236.083,516.105z"/>
	<g id="남해군">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M276.583,580.939l-1.833-3.5l-4-1.334l-3.833,2.334c0,0,0.666,3.332,0.166,3
			...
			/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M289.75,579.773l-4.5,0.832l-3.667,5.5l1.5,5.834h8l4,1.166l-1.333-3.666l0.833-3.166
			l-4-2.834l-1.833,4.334l-0.5-3.668l1.167-2L289.75,579.773z"/>
	</g>
	<g id="통영시">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M343.917,583.105l-3.5,3.5l-3.667,2.168l-1.167,2.832l2.834,0.834l2.666,0.666l1.834-2.5
			l1.833-4l1.667-1.666L343.917,583.105z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M332.917,591.105l-2.667,1l1,4.334l5.667,6l4.333-5.334l-4.833-1.832L332.917,591.105z"
			/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M348.083,596.939l-2.333,2.334l2,5.166l2.167-2.334L348.083,596.939z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M345.917,607.939l-1.5,4.834l2.833-2.668L345.917,607.939z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M343.083,571.773l-2.166,2.832l0.166,4l-1,4.834l-3,4l-2.333-2.5l-2.167,1.834
			l-6.5-2.668l0.167-2.5l5.833-0.5l-1.666-4.666l4-1.834l2-3.166l6.333-1.5L343.083,571.773z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M314.25,589.439h-6.167l3.334,4.334l2.166-2.5L314.25,589.439z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M317.25,593.439l-4.167,0.834l5.167,5l3-2.168L317.25,593.439z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M319.083,622.273l-2.333,0.332l0.5,3.5l4.167-0.5L319.083,622.273z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M309.25,612.105l-1.333,2.334l3.333,2l1-2.166L309.25,612.105z"/>
	</g>
</g>
<g id="부산광역시">
	<path id="기장군" fill="#B9B9B9" stroke="#FFFFFF" d="M442.875,534.855l-3.625-0.75l-4.625-2l-0.125-3.75l-3.5-4l-0.875-0.75
		...
		L442.875,534.855z"/>
	<path id="북구" fill="#B9B9B9" stroke="#FFFFFF" d="M412.75,533.98l0.875-5.625l0.125-1.25l2.25-5.75l1,0.75l3.25-1.25
		l-0.875,4.125l2.375,4.875l-1.875,3.875l-3.375,1.875L412.75,533.98z"/>
	<path id="금정구" fill="#B9B9B9" stroke="#FFFFFF" d="M428.75,532.73l3.375-4.625l0.25-2l-2.125-2.875l-0.125-4.75L429,517.105
		l-8.75,3.75l-0.875,4.125l2.375,4.875l4,1L428.75,532.73z"/>
	<path id="동래구" fill="#B9B9B9" stroke="#FFFFFF" d="M424.125,534.105l3,1.75l2,0.75l-0.375-3.875l-2.625-1.625l-4.25-0.875
		l-2,3.5L424.125,534.105z"/>
	<g id="강서구_1_">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M393.625,552.855l6-0.125l1.125-5.125l1.5-0.875l0.125,5.625l1.75-0.5l1.875-3.75l2-0.75
		...
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M392.75,554.73l-4.875,3.25l1.625,1l0.625,3l1.625,2.125l0.75,3.5l1.375-2.125
			l-0.5-2.625l1.25-2.625l1-3l-1-1.75L392.75,554.73z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M398.875,554.23l-3,0.375l1,1.625l2.5-0.375L398.875,554.23z"/>
	</g>
	<path id="사상구" fill="#B9B9B9" stroke="#FFFFFF" d="M410,547.105h3.25l2.75-3.875l-0.125-5.25l0.625-2.375l-3.75-1.625
		l-3.875,3.5l-0.25,6.625l-0.625,3.25L410,547.105z"/>
	<path id="사하구" fill="#B9B9B9" stroke="#FFFFFF" d="M413.625,551.73l1.875-0.25l-1.25-2.875l-1-1.5l-5.25,0.25l0.375,7
		L410,559.48l2.25-3.125l1.5,2.25v-3l-0.625-2.25L413.625,551.73z"/>
	<path id="연제구" fill="#B9B9B9" stroke="#FFFFFF" d="M420.125,535.605l2.375,1.5l2,1.375l0.125,1.5l1.875-0.25v-2l2.625-1.125
		l-2-0.75l-3-1.75l-4.25-0.375L420.125,535.605z"/>
	<path id="해운대구" fill="#B9B9B9" stroke="#FFFFFF" d="M431.625,540.105l-2.5-3.5l-0.375-3.875l3.375-4.625l0.5-1.625
		l1.875,1.875l0.25,3.25l4.875,2.625l3.25,0.625l-3.125,2.25l-1.25,3.75h-2.75l-0.875-0.875l-1.5,1L431.625,540.105z"/>
	<path id="부산진구" fill="#B9B9B9" stroke="#FFFFFF" d="M417.875,543.855L420,541.98l2.25,1.25l2.375-3.25l-0.375-1.875
		l-4.125-2.5l-0.25-1.875l-3,1.875l-1,2.375l0.125,5.25L417.875,543.855z"/>
	<path id="수영구" fill="#B9B9B9" stroke="#FFFFFF" d="M428.875,542.605l-2.375-2.875l0.375-2l1.875-1.125l2.875,3.5l1.75,0.875
		l-3.125,0.5l-0.625,1.625L428.875,542.605z"/>
	<path id="남구_1_" fill="#B9B9B9" stroke="#FFFFFF" d="M429.625,549.23l-2.25-0.25l-0.75-1.25l-2.375,0.875l-0.75-2.125l-1-1.625
		l-0.25-1.625l2.375-3.25l1.875-0.25l2.375,2.875l0.75,0.5l1.125,2.125L429.625,549.23z"/>
	<path id="동구_1_" fill="#B9B9B9" stroke="#FFFFFF" d="M421.25,546.855l-3,0.5l-1-1.5l0.625-2L420,541.98l2.25,1.25l0.25,1.625
		L421.25,546.855z"/>
	<path id="서구_1_" fill="#B9B9B9" stroke="#FFFFFF" d="M416.875,557.105L415,554.73l0.125-3.25l-0.875-2.875l-0.625-1.625
		l2.375-3.75l1.875,0.625l-0.625,2l1,1.5l-1.25,2l1.625,1.375l-1.75,2.125V557.105z"/>
	<path id="중구_2_" fill="#B9B9B9" stroke="#FFFFFF" d="M420.125,548.855v-1.75l-1.875,0.25l-1.25,2l1.625,1.375L420.125,548.855z
		"/>
	<path id="영도구" fill="#B9B9B9" stroke="#FFFFFF" d="M423.75,550.355l-3.625,0.25l-0.5,2.25l4.625,3.75l1.625-0.875l-1-3
		l-0.125-1.625L423.75,550.355z"/>
</g>
<g id="전라북도">
	<path id="무주군" fill="#B9B9B9" stroke="#FFFFFF" d="M230.083,429.605l1.333-3.332l-3.667-4.5v-3.001l-3-6.5l1-8.167l10,5.833
	...
	<path id="진안군" fill="#B9B9B9" stroke="#FFFFFF" d="M191.75,445.273l4.833-8.668l2.5-7.666v-4.166l2-0.5l0.5-8.668
		...
		L191.75,445.273z"/>
	<g id="전주시">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M164.917,438.773l-0.167-4.168l-3.667-1.5l-1.667-1.5l-2.667-3.832l2.333-1l3.167,0.666
			l4-0.834h8l3.667,7.168l4.667-0.5l2.167,5.164l1.667,0.668l-1.167,2l-6-0.334l-2.833-3.334l-5.167-0.5l-1.667-1l-1.667,1
			L164.917,438.773z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M165.917,445.105l-0.5-3.5l0.333-1.5l-0.833-1.332l4.667-2.834l1.667,1l5.167,0.5
	...
	<g id="완주군">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M179.417,452.773l-5.5,4.666l-0.167,6.166l-0.167,3.168l-5.667,6l-0.167-9.668
		...
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M156.75,436.105l2.167-4.832l2.167,1.832l3.667,1.5l0.333,3.5l0.667,2l-0.333,1.5
			l0.5,3.5l-2.5-1l-4.333-2.332L156.75,436.105z"/>
	</g>
	<path id="익산시" fill="#B9B9B9" stroke="#FFFFFF" d="M153.583,426.105l-3-1.166h-11.667c0,0,5-8.334,5-8.834
	...
	<path id="장수군" fill="#B9B9B9" stroke="#FFFFFF" d="M203.083,480.273l2.333-3l0.5-6l6-1.668l5-0.332l0.5-4l-0.833-3.834
	...
	<path id="남원군" fill="#B9B9B9" stroke="#FFFFFF" d="M181.25,513.73l2.875-4l2.125-4.875l3.375-0.375l0.5-3.125l3.75-0.75
	...
	<path id="임실군" fill="#B9B9B9" stroke="#FFFFFF" d="M178.875,495.23l-3.75-0.625l-1.875-5.5l-4.875-1.5v-2.75l2.375-2.125
	...
	<path id="순창군" fill="#B9B9B9" stroke="#FFFFFF" d="M138,492.605l10.25-0.375l0.375-4.25l-0.25-2.625l5.375-4.625l2.5,2.125
	...
	<path id="정읍시" fill="#B9B9B9" stroke="#FFFFFF" d="M142,449.105l-0.75,1.375l0.375,0.875L139,453.48l-6,1.625l2.875,2.75
	...
	<path id="김제시" fill="#B9B9B9" stroke="#FFFFFF" d="M127.875,441.73l-10-5.75l3.75-4.125l3-0.75l4.25,1.125l2.25-4.25l5.875-3
	...
	<path id="부안군" fill="#B9B9B9" stroke="#FFFFFF" d="M114.875,478.73l-4.75-5.5l-10,0.875l-5,2.5l-7.625-6.25l0.25-4.25
	...
	<path id="고창군" fill="#B9B9B9" stroke="#FFFFFF" d="M84.125,499.23l7.375-13.125l7.5-3.25l6.25-0.125l4.125-3.5l5.25,1.25
	...
	<g id="군산시">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M127.75,427.773l5-3.168l6.167,0.334l5-8.834l2.167-6.667l-4.833-4.166l-1.167-4.167
		...
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M80.583,437.105l-0.5,5l3-1.5L80.583,437.105z"/>
	</g>
</g>
<g id="광주광역시">
	<path id="광산구" fill="#B9B9B9" stroke="#FFFFFF" d="M136.833,531.355l-5.083,2.25l-6.167-2.916l-0.25-2.666h-2.25l-1.75,6.166
	...
	<path id="북구_3_" fill="#B9B9B9" stroke="#FFFFFF" d="M145.583,526.605l-3.333,2l-2.833,0.084l-2.583,2.666l0.75,1l0.333,4.75
	...
	<path id="동구_5_" fill="#B9B9B9" stroke="#FFFFFF" d="M147.583,547.689l-0.833-2.834l-0.167-1.332l1.75-0.75l2.083,1.082
		l1.417,2.334l2.833,1.084l2.167,2.832l-2,3l-3.583,1.668l-1,1.5l-3.833-3.168l0.083-3.666L147.583,547.689z"/>
	<path id="남구_4_" fill="#B9B9B9" stroke="#FFFFFF" d="M134.667,552.773l2.583-2l4.25-1.168l1.583-0.916L143,545.855l1.75-2.166
		...
		H134.667z"/>
	<path id="서구_4_" fill="#B9B9B9" stroke="#FFFFFF" d="M133.5,549.023l1.167-1.918l2.083-5.666h4.167l3.833,2.25l-1.417,1.916
		l-0.167,2.834l-1.667,1.166l-4.25,1.168l-2.417,2h-2.583v-2.334L133.5,549.023z"/>
</g>
<g id="전라남도">
	<path id="구례군" fill="#B9B9B9" stroke="#FFFFFF" d="M210.5,538.355l-5.75-0.5v-5l5.25-2.5l-3.5-6l0.25-4.625l6.375-8.625
		l6.875,0.25l7,4.5l4.25,4.25l2.25,4l4.25,6l-0.75,8.75l-1.5,3l-0.75,6l-3,1.25l-4.5,3l-3.25-4.5h-1.75l-4.5-4.25l-3.75-3
		L210.5,538.355z"/>
	<path id="곡성군" fill="#B9B9B9" stroke="#FFFFFF" d="M182.25,546.605l-0.333-6.166l0.333-3.666l-2-3.168l-3,3.334l-6,0.166
	...
	<path id="담양군" fill="#B9B9B9" stroke="#FFFFFF" d="M161.417,546.273l6,3.166l1.333-3.166l-2.5-6.5h2.667l2.333-2.668
	...
	<path id="장성군" fill="#B9B9B9" stroke="#FFFFFF" d="M108.583,532.771c0,0-4.5-1.998-4.667-2.666
	...
	<path id="영광군" fill="#B9B9B9" stroke="#FFFFFF" d="M69.917,539.439l7.5-4.334l-2.667,3.5l1,3.334l5.333-2.5l2.333,0.5
	...
	<path id="함평군" fill="#B9B9B9" stroke="#FFFFFF" d="M89.75,563.939l-1.5-3.666l1.167-2.834l-4-2.834l2.167-2.666l-5.833-1.334
	...
	<path id="순천시" fill="#B9B9B9" stroke="#FFFFFF" d="M180.75,570.939l-0.167-6.5l0.5-7.334l-0.833-6l2-4.5l6,4l4.333,3.5
		...
		L180.75,570.939z"/>
	<g id="광양시">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M228.25,574.855l0.5-7.75l-1.25-5.5l-3-4.5l2.75-5l4.5-3l3-1.25l0.75-6l1.5-3
		...
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M251.917,578.439l-2.334,3.332l2.5,1.334l3.5-3L251.917,578.439z"/>
	</g>
	<g id="여수시">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M239.083,625.605l-3.333-2.5h-2.5v2.334l-3.333-3.834l-1.5-5.666l1.5-1.334l-1.167-3.332
		...
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M260.75,632.439l-4.667-0.5l-5.666-5l0.166-3.666l3.5-6l-0.166-5l1-1.5l3,2l-0.667,5.332
			l3.167,3l-0.834,7.168c0,0,1.834,0.832,1.834,1.332S260.75,632.439,260.75,632.439z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M251.417,638.273l-3.5,3.166l3.5,0.834l2.5,3l3.833,2.666l1.5-1.666l-2.667-2.334
			l0.667-1.166l-2.167-3.668L251.417,638.273z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M241.583,632.273l-2,2.166l1.167,3.334l3.833-0.668v-2.166L241.583,632.273z"/>
	</g>
	<path id="화순군" fill="#B9B9B9" stroke="#FFFFFF" d="M134.417,588.773l4.833-3.5l1.833-9.834l2.833-5.166l-3-5l2.333-6.668
	...
	<path id="나주시" fill="#B9B9B9" stroke="#FFFFFF" d="M93.583,578.939l3.333,5.334l2.833,4.832l1.833-5.5l2.5-3.332l3.5,0.332
	...
	<g id="무안군">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M72.917,566.939l2.167,2.166l1.333-0.666l0.833,3.334l1.333,2.832l0.5,6.334l1.5,1.334
		...
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M72.917,543.105l-4,3l-4.5-1.332c0,0-4.333,0.5-4.333,1s-0.333,4.666-0.333,4.666
		...
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M74.583,554.273l-2.5,0.832l-1.333,3.834l3,2.666l3.333-1.666l3.167-0.334v-3.666
			l-3.167-2.166l-1,2.832L74.583,554.273z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M72.083,571.439c-0.5,0-2.833-0.666-2.833-0.666l-2-0.168l-1,3.168l5.167,5.832
			l0.833,1.834c0,0,3-3.166,3-3.666s0-4.334,0-4.334l-1-2.834L72.083,571.439z"/>
	</g>
	<path id="목포시" fill="#B9B9B9" stroke="#FFFFFF" d="M78.75,593.273l-2.333,2.666l-2.167,3.166l3.333,3.168l5.167-1
		l2.333-0.168l2.667-0.332l-0.833-4.334l-1.5-0.834l-2-3.166l-2.5-1.166L78.75,593.273z"/>
	<path id="영암군" fill="#B9B9B9" stroke="#FFFFFF" d="M77.083,609.273l5.167-0.668l3.667,1.5l5.667-0.832l6.5,7.832
	...
	<path id="보성군" fill="#B9B9B9" stroke="#FFFFFF" d="M162.917,623.605l5-4.166l4.5-4.166l2.667,1.332l5.833-1.332l3.833-7.5
	...
	<g id="고흥군">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M171.917,639.939l0.833-6.666l4.5-3l3.5-6l3-1.5l-1.667,4l-1.167,5.332l4.5,0.334
		...
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M183.417,647.773h-5.333l-4.167,1.166c0,0-2.833-1.166-3-0.166s-0.5,5.332-0.5,5.332
			l4.667,3.834l8-0.5l2-3.166l1-4L183.417,647.773z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M219.083,644.105l-3.5,1.168l-0.333,3l5-0.668l1.833-1.332L219.083,644.105z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M222.75,651.439l-5-0.666l-1.5,2l6.5,4.5l1.167,2.166l2.667-4L222.75,651.439z"/>
	</g>
	<path id="장흥군" fill="#B9B9B9" stroke="#FFFFFF" d="M137.583,628.105l3.5-0.5l-1-6.666l-1.833-3.334v-5.166l-4.167-5.668
	...
	<path id="강진군" fill="#B9B9B9" stroke="#FFFFFF" d="M122.083,652.605l2.333-1.832l-0.833-1.834l2.167-2
	...
	<path id="해남군" fill="#B9B9B9" stroke="#FFFFFF" d="M71.083,608.939l-5.167-3.334l-2.167,6l-3.167,2.668v9.166l3.167,1.666
		...
		L71.083,608.939z"/>
	<g id="진도군">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M60.083,632.273l-1.667,3.5l2.833,1.166l0.667,3.666c0,0-5.333,0.5-5.833,0.5
			...
			L60.083,632.273z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M33.25,675.273l-0.833-1.168l-3.167,4.668l4,2l5.667-0.168l-0.167-4.5l-2.667-0.166
			L33.25,675.273z"/>
	</g>
	<g id="완도군">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M111.25,663.105l5.125-0.625l5.125,2.5l0.75,4.75l4.375,5.25l0.875,4l-4.375-0.25
			l-5.375-0.25l-3.75-4.625l-2.75-1.125V663.105z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M134.75,655.855l-3.375,1l-4.875,3.25l-1.25,3.5l1.75,1.375l2.5,1.125l4.5-2.25
			l4.625-2.125l-3.375-1.875l1.25-1L134.75,655.855z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M135,668.98l-1.75,1.625l-3.75-0.625l-1.25,3.25l5.125,1.625l2.25,0.25l1.125,2.75
			l3.125-2.25l2.5-0.625l0.375-2.25l-2.25-1.625l-1.125-1.375h-3.25L135,668.98z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M141.5,691.48l-2.625,1.625l-1,4.875l2.875,1.25l7.25-0.125l-0.5-3.125l-2.125-1
			l-0.625-3.25L141.5,691.48z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M99.125,688.73l-0.75,4l1.875,3.5c0,0,6.5,0.125,6.5-0.375s-0.625-2.25-0.625-2.25
			l1.25-1.5l-2-2.625l-3.125-0.375L99.125,688.73z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M99,697.355l-3.875-1.25l-2.25,2.5L93,702.98l3.75,1.5l3.25-2.625l3.125-3L99,697.355z"
			/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M111.875,693.98l-1.75,2.5l2.75,0.375l2.25-0.75l-1.125-1L111.875,693.98z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M110.125,699.855l-0.75,3.625l2.125,2.75l1.375-2.5l0.375-3.5l-1.875-0.5
			L110.125,699.855z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M160.875,664.98c0,0-2.75-0.375-2.75,0.5s0.875,4.125,0.875,4.125s2.75,2.75,2.875,3.25
			s0,4.25,0.5,3.5s4.125-4.125,4.125-4.125l3.75-1.625c0,0-3.375-4-3.75-4s-2.5,2.25-2.5,2.25L160.875,664.98z"/>
	</g>
	<g id="신안군">
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M37.083,577.273l-1.167,2.832l-4.333-0.166l-3.667,2.5l-2.833,4.334l-2.333,0.5l9,2l4,2
			l4.333-3.834l1.167-4l-2.5-2.666L37.083,577.273z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M25.75,598.273l-5.5,4l-5.167-0.334l-1.333,8l3,2.166l3.667-1.666v-3.166l5-1.5l2-6
			L25.75,598.273z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M22.25,609.939l-1.167,2l-4.833,1.334l1.333,3.832l5.667,3.5l2.833-2.832l3-2.5
			l-0.5-4.668l-2.833,1.834L22.25,609.939z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M33.417,620.439l-3.333,4.666l-0.833,4.168l1,3.666l2.5,1.334l2.5-2.668l-1.667-3
			l-0.833-3.666l1.5-2L33.417,620.439z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M39.417,628.439l-2.5,1.834l2.167,4l-3.667,3l-1.833,0.832l2,1.168l-0.667,2.5l3-2.5
			l2.667-3l1.5-3.668l-2-2.166L39.417,628.439z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M48.25,597.105l-2.333,1.5l-5.667,0.668l3.667,2.5l2.667,1.5l2.667-2.334L48.25,597.105z
			"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M47.417,606.273l-2.833-1.334l-3.333-1.666l-0.833,5.5l0.833,6.332l4.333-1.5
			l4.667-3.166L47.417,606.273z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M43.917,587.605l-0.833,1.834l-3.5,1.666l-1.167,2.5l3.333,2.5l1.167-2.832l2.667-0.834
			l-0.167-2l1.5-2.334L43.917,587.605z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M46.583,618.273l-3.5,3.332l2.5,4.168l3.333-2l0.833-3.168L46.583,618.273z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M66.917,580.439l-2,0.834l1.667,2.666l-1.333,1.334l-2.5,2.166l-4,2l4.167,1.666l2.5-1
			l5.833,1.668l-0.667,2.666l3.667-0.834l0.333-3.5l-3.667-1l-2.167-0.5l1.167-3.166l2.667-0.834l-2.667-2.5L66.917,580.439z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M47.083,544.939l-6,2.666l-3.833,4.334c0,0-4.5,2.332-4.167,2.832s2.333,4,2.333,4
			l5.667-0.332l2-4.5l0.167-3.668l3.667-3.666L47.083,544.939z"/>
		<path fill="#B9B9B9" stroke="#FFFFFF" d="M45.25,564.105l-3.5,2.5l3.5,0.666l0.5,6c0,0-3,2.334-2.167,2.5
			c0.833,0.168,5.833,0.168,5.833,0.168l0.333-4.334l-0.667-3.666L45.25,564.105z"/>
	</g>
</g>
<g id="레이어_19">
	<path fill="none" stroke="#000000" d="M499.25,715.605h-133v-85h133V715.605z"/>
	<path fill="none" stroke="#000000" d="M31,194.355H0.5v-30.5H31V194.355z"/>
	<path fill="none" stroke="#000000" d="M46.25,194.105H36v-10.25h10.25V194.105z"/>
	<path fill="none" stroke="#000000" d="M497,370.855h-24v-24h24V370.855z"/>
	<path fill="none" stroke="#000000" d="M508.5,370.605h-8.25v-8.25h8.25V370.605z"/>
</g>
<path id="세종특별자치시" fill="#B9B9B9" stroke="#FFFFFF" d="M191.876,343.855l-5.375-3.469l-2.313-3.406L183,332.052
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    ...
                    <p class="copyright text-muted">Copyright &copy; MP Proj  Website 2015</p>
                </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
		// var bClicked = false;
			$("g").mouseover(function(event) {
				...
				var city_name = _path.id;
				var province = $(_path).parent()[0].id;
				/* alert('MouseClickEvent : ' + province); */
			});
	</script>
