...
<body>
    ...
    <header class="intro-header" style="background-image: url('img/cdbl-bg.jpg')">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="post-heading">
                        <h1>Medical & Pharmaceutical DB Layout ver 4.1.1</h1>
                        <h2 class="subheading">This DB Layout Explain How to Use</h2>
                        <span class="meta">Posted by <a href="project?cmd=about_us">JH.Kim * 2</a> on August 24, 2015</span>
                    </div>
                </div>
            </div>
        </div>
