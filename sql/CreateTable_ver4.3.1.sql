...
-- -----------------------------------------------------
-- Table `MPDatabase`.`DH_SPECIFICATION`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MPDatabase`.`DH_SPECIFICATION` (
  `PERSON_ID` INT(8) NOT NULL,
  `KEY_SEQ` VARCHAR(12) NOT NULL,
  `YKIHO_ID` INT(6) NULL,
  `RECU_FR_DT` VARCHAR(8) NULL,
...
-- -----------------------------------------------------
-- Table `MPDatabase`.`DH_SB_DETAIL`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MPDatabase`.`DH_SB_DETAIL` (
  `KEY_SEQ` VARCHAR(12) NOT NULL,
  `SEQ_NO` INT(4) NOT NULL,
  `RECU_FR_DT` VARCHAR(8) NULL,
  `DSBJT_CD` VARCHAR(2) NULL,
  ...
  PRIMARY KEY (`KEY_SEQ`, `SEQ_NO`),
  INDEX `fk_상병내역_명세서1_idx` (`KEY_SEQ` ASC),
  CONSTRAINT `fk_상병내역_명세서10`
    FOREIGN KEY (`KEY_SEQ`)
    REFERENCES `MPDatabase`.`DH_SPECIFICATION` (`KEY_SEQ`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MPDatabase`.`DH_MEDICAL_DB_SPECIFI_SUB_DETAIL`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MPDatabase`.`DH_MEDICAL_DB_SPECIFI_SUB_DETAIL` (
  `KEY_SEQ` VARCHAR(12) NOT NULL,
  `SEQ_NO` INT(4) NOT NULL,
  `RECU_FR_DT` VARCHAR(8) NULL,
  `DIV_TYPE_CD` VARCHAR(1) NULL,
  ...
  PRIMARY KEY (`KEY_SEQ`, `SEQ_NO`),
  INDEX `fk_진료DB처방전교부상세내역_명세서1_idx` (`KEY_SEQ` ASC),
  CONSTRAINT `fk_진료DB처방전교부상세내역_명세서10`
    FOREIGN KEY (`KEY_SEQ`)
    REFERENCES `MPDatabase`.`DH_SPECIFICATION` (`KEY_SEQ`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `MPDatabase`.`DH_MEDICAL_DETAIL`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MPDatabase`.`DH_MEDICAL_DETAIL` (
  `KEY_SEQ` VARCHAR(12) NOT NULL,
  `SEQ_NO` INT(4) NOT NULL,
  `RECU_FR_DT` VARCHAR(8) NULL,
  `CLAUSE_CD` VARCHAR(2) NULL,
...
-- -----------------------------------------------------
-- Table `MPDatabase`.`HEALTH_SCREENINGS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MPDatabase`.`HEALTH_SCREENINGS` (
  `HCHK_YEAR` VARCHAR(4) NOT NULL,
  `PERSON_ID` INT(8) NOT NULL,
  `YKIHO_GUBUN_CD` INT(3) NULL,
  `HEIGHT` INT(3) NULL,
  `WEIGHT` INT(3) NULL,
  `BP_HIGH` INT(3) NULL,
  `BP_LWST` INT(3) NULL,
  `BLDS` INT(3) NULL,
  `TOT_CHOLE` INT(3) NULL,
  `HMG` DOUBLE NULL,
  `GLY_CD` INT(1) NULL,
  `OLIG_OCCU_CD` INT(1) NULL,
  `OLIG_PH` DOUBLE NULL,
  `OLIG_PROTE_CD` INT(1) NULL,
  `SGOT_AST` INT(3) NULL,
  `SGPT_ALT` INT(3) NULL,
  `GAMMA_GTP` INT(3) NULL,
  `HCHK_PMH_CD1` INT(1) NULL,
  `HCHK_PMH_CD2` INT(1) NULL,
  `HCHK_PMH_CD3` INT(1) NULL,
  `FMLY_LIVER_DISE_PATIEN_YN` INT(1) NULL,
  `FMLY_HPRTS_PATIEN_YN` INT(1) NULL,
  `FMLY_APOP_PATIEN_YN` INT(1) NULL,
  `FMLY_HDISE_PATIEN_YN` INT(1) NULL,
  `FMLY_DIABML_PATIEN_YN` INT(1) NULL,
  `FMLY_CANCER_PATIEN_YN` INT(1) NULL,
  `SMK_STAT_TYPE_RSPS_CD` INT(1) NULL,
  `SMK_TERM_RSPS_CD` INT(1) NULL,
  `DSQTY_RSPS_CD` INT(1) NULL,
  `DRNK_HABIT_RSPS_CD` INT(1) NULL,
  `TM1_DRKQTY_RSPS_CD` INT(1) NULL,
  `EXERCI_FREQ_RSPS_CD` INT(1) NULL,
  PRIMARY KEY (`HCHK_YEAR`, `PERSON_ID`),
  INDEX `fk_HEALTH_SCREENINGS_PERSON1_idx` (`PERSON_ID` ASC),
  CONSTRAINT `fk_HEALTH_SCREENINGS_PERSON1`
    FOREIGN KEY (`PERSON_ID`)
    REFERENCES `MPDatabase`.`PERSON` (`PERSON_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `MPDatabase`.`AGE_CODE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MPDatabase`.`AGE_CODE` (
  `AGE_GROUP` VARCHAR(2) NOT NULL,
  `RANGE` VARCHAR(7) NOT NULL,
...
-- -----------------------------------------------------
-- Table `MPDatabase`.`HC_CODE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MPDatabase`.`HC_CODE` (
  `DSBJT_CD` VARCHAR(2) NOT NULL,
  `HC_NAME` VARCHAR(25) NOT NULL,
  PRIMARY KEY (`DSBJT_CD`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `MPDatabase`.`SIDO_CODE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MPDatabase`.`SIDO_CODE` (
  `SGG` VARCHAR(2) NOT NULL,
  `SIDO_NAME` VARCHAR(5) NULL,
  `GU_NAME` VARCHAR(7) NULL,
  PRIMARY KEY (`SGG`))
ENGINE = InnoDB;
