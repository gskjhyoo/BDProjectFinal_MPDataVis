...
-- -----------------------------------------------------
-- Table `MPDatabase`.`MEDICAL_DETAIL`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MPDatabase`.`MEDICAL_DETAIL` (
  `KEY_SEQ` VARCHAR(12) NOT NULL,
  ...
  CONSTRAINT `fk_진료내역_명세서1`
    FOREIGN KEY (`KEY_SEQ`)
    REFERENCES `MPDatabase`.`SPECIFICATION` (`KEY_SEQ`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MPDatabase`.`SB_DETAIL`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MPDatabase`.`SB_DETAIL` (
  `KEY_SEQ` VARCHAR(12) NOT NULL,
  `SEQ_NO` INT(4) NOT NULL,
  `RECU_FR_DT` VARCHAR(8) NULL,
  `DSBJT_CD` VARCHAR(2) NULL,
...
-- -----------------------------------------------------
-- Table `MPDatabase`.`MEDICAL_DB_SPECIFI_SUB_DETAIL`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MPDatabase`.`MEDICAL_DB_SPECIFI_SUB_DETAIL` (
  `KEY_SEQ` VARCHAR(12) NOT NULL,
  `SEQ_NO` INT(4) NOT NULL,
  `RECU_FR_DT` VARCHAR(8) NULL,
  `DIV_TYPE_CD` VARCHAR(1) NULL,
